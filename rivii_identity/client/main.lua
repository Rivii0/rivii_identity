...
RegisterNetEvent('rivii_identity:alreadyRegistered', function()
    while not loadingScreenFinished do Wait(100) end
    TriggerEvent('esx_skin:playerRegistered')
end)

RegisterNetEvent('rivii_identity:setPlayerData', function(data)
...
if not Config.UseDeferrals then
    ...
    RegisterNetEvent('rivii_identity:showRegisterIdentity', function()
        TriggerEvent('esx_skin:resetFirstSpawn')
        while not (ready and loadingScreenFinished) do
            print('Waiting for rivii_identity NUI..')
            Wait(100)
        end
    ...
    RegisterNUICallback('register', function(data,cb)
        ...
        ESX.TriggerServerCallback('rivii_identity:registerIdentity', function(callback)
