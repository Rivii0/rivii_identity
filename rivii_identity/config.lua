...
Config.MinHeight       = 160                         -- 160 cm lowest height
Config.MaxHeight       = 220                         -- 220 cm max height.
Config.LowestYear      = 1925                        -- 112 years old is the oldest you can be.
Config.HighestYear     = 2004                        -- 21 years old is the youngest you can be.
